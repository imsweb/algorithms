...
- Split the PRCDA-UIHO algorithm into 2 separate algorithms: PRCDA and UIHO. Updated both algorithms to produce '2020' values. Added a '2017' calculation to the PRCDA algorithm.
...
- Added site-specific surgery tables for 2022 DX year (note that all the histology exceptions were removed in this release).
