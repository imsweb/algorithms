...
public class TractEstCongressDistUtilsTest {
    ...
    public void testComputeTractEstCongressDist() {
        ...
        Assert.assertEquals("0633", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
        input.setCensusTract2020("007903");
        Assert.assertEquals("0633", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());

        // test Puerto Rico
        input.setAddressAtDxState("PR");
        input.setCountyAtDxAnalysis("001");
        input.setCensusTract2010("956300");
        Assert.assertEquals("7298", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
        input.setCensusTract2020("956300");
        Assert.assertNull(TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
            ...
            for (String county : Arrays.asList("067", "INVALID")) {
                for (String tract : Arrays.asList("012720", "INVALID")) {
                    ...
                    if ("WA".equals(state) && "067".equals(county) && "012720".equals(tract)) {
                        Assert.assertEquals(key, "5303", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
                        Assert.assertEquals(key, "5303", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
                    }
                    else {
                        Assert.assertEquals(key, "A", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
                        Assert.assertEquals(key, "A", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
                    }
                }
            }
        }
        ...
        Assert.assertEquals("B", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
        input.setCensusTract2020("012720");
        Assert.assertEquals("B", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
            ...
            for (String county : Arrays.asList("067", "555")) {
                for (String tract : Arrays.asList("012720", "555555")) {
                    ...
                    if ("WA".equals(state) && "067".equals(county) && "012720".equals(tract)) {
                        ...
                        Assert.assertEquals(key, "C", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
                        Assert.assertEquals(key, "C", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
                    }
                }
            }
        }
            ...
            for (String county : Arrays.asList("067", "999", null)) {
                for (String tract : Arrays.asList("012720", "999999", null)) {
                    ...
                    if ("WA".equals(state) && "067".equals(county) && "012720".equals(tract)) {
                        ...
                        Assert.assertEquals(key, "D", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2010());
                        Assert.assertEquals(key, "D", TractEstCongressDistUtils.computeTractEstCongressDist(input).getTractEstCongressDist2020());
                    }
                }
            }
        }
