...
public class EphtSubCountyUtilsTest {
    ...
    public void testComputeEphtSubCounty() {
        ...
        Assert.assertEquals("99999999999", computeEphtSubCounty(record).getEpht2010GeoId5k());
        Assert.assertEquals("99999999999", computeEphtSubCounty(record).getEpht2010GeoId20k());
    }
