...
public class EphtSubCountyUtilsTest {
    ...
    public void testComputeEphtSubCounty() {
        ...
        Assert.assertEquals("00000967702", computeEphtSubCounty(record).getEpht2010GeoId5k());
        ...
        Assert.assertEquals("00000020900", computeEphtSubCounty(record).getEpht2010GeoId5k());
        record.clear();
        record.put(_PROP_STATE_DX, "WY");
        record.put(_PROP_COUNTY_DX_ANALYSIS, "039");
        record.put(_PROP_CENSUS_TRACT_2010, "967702");
        Assert.assertEquals("00000967702", computeEphtSubCounty(record).getEpht2010GeoId5k());
        Assert.assertEquals("00005603955", computeEphtSubCounty(record).getEpht2010GeoId20k());
        record.clear();
        record.put(_PROP_STATE_DX, "HI");
        record.put(_PROP_COUNTY_DX_ANALYSIS, "003");
        record.put(_PROP_CENSUS_TRACT_2010, "003405");
        Assert.assertEquals("00000003405", computeEphtSubCounty(record).getEpht2010GeoId5k());
        Assert.assertEquals("00001500392", computeEphtSubCounty(record).getEpht2010GeoId20k());
    }
