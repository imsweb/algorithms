...
public class AyaSiteRecodeUtilsTest {
    ...
    public void testCalculateSiteRecode2020Revision () {
        Assert.assertEquals("999", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, null, null, null));
        Assert.assertEquals("999", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "", "", ""));
        Assert.assertEquals("999", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", null, null));
        Assert.assertEquals("999", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "9827", null));
        Assert.assertEquals("001", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "9827", "3"));
        Assert.assertEquals("001", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "9811", "3"));
        Assert.assertEquals("001", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "9815", "3"));
        Assert.assertEquals("001", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "9818", "3"));
        Assert.assertEquals("075", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "8800", "3"));
        Assert.assertEquals("204", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "8000", "3"));
        Assert.assertEquals("218", AyaSiteRecodeUtils.calculateSiteRecode(ALG_VERSION_2020, "C420", "8000", "2"));
    }
}
