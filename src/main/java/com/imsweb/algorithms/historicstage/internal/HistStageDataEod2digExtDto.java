...
public class HistStageDataEod2digExtDto extends HistStageDataDto {
    ...
    public HistStageDataEod2digExtDto(String[] row) {
    ...
    public String computeResult(String histology, String site, String dig1, String dig2) {
        String result = null;
