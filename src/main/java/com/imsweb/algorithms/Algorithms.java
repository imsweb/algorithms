...
public class Algorithms {
    ...
    public static void initialize() {
        ...
        try {
            ...
            addField(_CACHED_FIELDS, AlgorithmField.of(FIELD_IHS_PRCDA, null, 1, "PRCDA County 2018", "PRCDA Cty 18", DATA_LEVEL_TUMOR));
            addField(_CACHED_FIELDS, AlgorithmField.of(FIELD_UIHO, null, 1, "UIHO County 2020", "UIHO Cty 20", DATA_LEVEL_TUMOR));
