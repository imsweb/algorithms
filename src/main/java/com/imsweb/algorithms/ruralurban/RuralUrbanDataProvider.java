 ...
 * <ul>
 * <li>get the rural urban continuum code for the provided year category, state of dx, and county of dx for analysis</li>
 * <li>get the rural urban commuting area code for the provided year category, state of dx, county of dx for analysis, and census tract</li>
 * <li>get the rural urban census code for the provided year category, state of dx, county of dx for analysis, and census tract</li>
 * </ul>
...
public interface RuralUrbanDataProvider {
    ...
    /**
     * Returns urban rural indicator code (URIC) for provided year category, state of dx, county of dx for analysis, and census tract.
     * <p/>
    ...
    /**
     * Returns urban rural indicator code (URIC) percentage for provided year category, state of dx, county of dx for analysis, and census tract.
     * <p/>
    ...
    /**
     * Returns rural urban continuum code for provided year category, state of dx, and county of dx for analysis.
     * <p/>
     * Created Aug 11, 2014 by HoweW
