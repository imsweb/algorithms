...
/********* Documentation *******************************************************************************************************************;
 Written by Andy Lake (lakea@imsweb.com), Information Management Services, Inc. July 2008
 ...
 1. Program allows users to run for naaccr layout file version 12
...
filename fmats 'NHAPIIA_Formats_2010_11_01.xpt';
...
*****************************************************************************;
/*NAACCR Version 12 input registry file, with the following fields included:
   ...
   Birthplace                 [item #250,  column   206] ---- NAPIIA & NHIA
...
**** Output file Name - NAACCR Version 12 registry incidence file without names and with generated NHIA and NAPIIA values;
filename submit "napiia-test-sas.txt";
...
data registry_data ;
 ...
 /* Step 2 - Evaluate Spanish/Hispanic Origin [item #190] for cases originally reported as non-Hispanic, surname only,
  ...
  /* 2009 Change - Code for Belize was removed (252) */

  if DataItem_160 in ('96','97') then do;
     if DataItem_250='101' then naaccrhid=2; /*Puerto Rican by Birthplace*/
     else if DataItem_250='230' then naaccrhid=1; /*Mexican by Birthplace*/
     else if DataItem_250='241' then naaccrhid=3; /*Cuban by Birthplace*/
     else if DataItem_250='243' then naaccrhid=8; /*Dominican Republic Birthplace*/
     else if DataItem_250 in ('250','251','253','254','255','256','257','300',
                         '311','321','345','351','355','361','365','371','375','265') then naaccrhid=4; /*South or Central American by Birthplace - code 252 removed in 2009*/
     else if DataItem_250='443' then naaccrhid=5; /*Other specified Spanish/Hispanic Origin by Birthplace*/
  ...
  /* Evaluate casees with the following:
     ...
     Birthplaces Associated with Prevalence of Spanish Surnames but Low Probability of Hispanic Ethnicity
      ...
      332                             Suriname
      333                             French Guyana
      440-441; 445-499                Europe including Portugal
      675                             Philippines */


  else if DataItem_190 in (0,7,9) and (put(DataItem_250,$BP.) NE 'Y') then do;
  /* In general, those cases born in birthplaces shown in the table below have high probabilities of being
     ...
     101    Puerto Rico           2                257    Panama         4
     ...
     253    Honduras              4                355    Bolivia        4
     254    El Salvador           4                361    Chile          4
     255    Nicaragua             4                365    Argentina      4
     256    Costa Rica            4                371    Paraguay       4
     265    Latin America, NOS    4                375    Uruguay        4

     443    Spain (including Canary Islands, Baleric Island,and Andorra) 5
     *** New for 2009 - 252 Belize was removed
     ...
     if DataItem_250='101' then naaccrhid=2; /*Puerto Rican by Birthplace*/
                         ...
                         '311','321','345','351','355','361','365','371','375','265') then naaccrhid=4; /*South or Central American by Birthplace - 252 removed in 2009*/
     else if DataItem_250='443' then naaccrhid=5; /*Other specified Spanish/Hispanic Origin by Birthplace*/
...
data registry_data
  ...
  **********************************************************************************************************************************************************/
    step_3_in_count+1;
    api_birth_place=put(DataItem_250,$api_bp.);
  ...
  ******** Create Counts For Final Summary Report;
  ...
  Proc freq data=registry_data;
    tables New_api*DataItem_250_print/list missing;
    where step_31=1;
...
data registry_data ;
  infile regfile truncover missover lrecl=5564 pad end=last_record;
    ...
    input DataItem_250	     $206 -	208  @;	label DataItem_250	   = 'Birth Place';
  ...
  DataItem_250_print=trim(put(DataItem_250,$b_place.));
  ...
  **** create State/County Variable and check to make sure an option is chosen;
  percent_hispanic=put(DataItem_80||DataItem_90,$pct_hsp.);
...
/*Create NAACCR version 12 file for submission - Incidence data with generated with NHIA and NAPIIA values*/
data _null_;
  set registry_data;
